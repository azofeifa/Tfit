...
out_directory=/Users/azofeifa/Lab/gro_seq_files/HCT116/EMG_out_files/cpp_model_fits
maxK=5
rounds=64

$src $config_file  -i $formatted_in_file -o $out_directory -np $PBS_ARRAYID -rounds $rounds
